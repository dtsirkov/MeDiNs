...
/**
 * Home object for domain model class Policies.
 * @see pojo_classes.Policies
 * @author Hibernate Tools
 */
public class PoliciesHome {

	private static final Log log = LogFactory.getLog(PoliciesHome.class);
	...
	public void persist(Policies transientInstance) {
		log.debug("persisting Policies instance");
		try {
	...
	public Policies merge(Policies detachedInstance) {
		...
		try {
			Policies result = (Policies) sessionFactory.getCurrentSession()
	...
	public Policies findById(java.lang.String id) {
		log.debug("getting Policies instance with id: " + id);
		try {
			Policies instance = (Policies) sessionFactory.getCurrentSession()
					.get("pojo_classes.Policies", id);
			if (instance == null) {
	...
	public List findByExample(Policies instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("pojo_classes.Policies")
