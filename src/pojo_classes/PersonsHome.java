...
public class PersonsHome {
	...
	public Persons merge(Persons detachedInstance) {
		...
		try {
			Persons result = (Persons) sessionFactory.getCurrentSession()
	...
	public Persons findById(java.lang.String id) {
		...
		try {
			Persons instance = (Persons) sessionFactory.getCurrentSession()
					.get("pojo_classes.Persons", id);
			if (instance == null) {
	...
	public List findByExample(Persons instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("pojo_classes.Persons")
