...
/**
 * Home object for domain model class CaseInfo.
 * @see pojo.classes.CaseInfo
 * @author Hibernate Tools
 */
public class CaseInfoHome {

	private static final Log log = LogFactory.getLog(CaseInfoHome.class);
	...
	public void persist(CaseInfo transientInstance) {
		log.debug("persisting CaseInfo instance");
		try {
	...
	public CaseInfo merge(CaseInfo detachedInstance) {
		...
		try {
			CaseInfo result = (CaseInfo) sessionFactory.getCurrentSession()
	...
	public CaseInfo findById(java.lang.Integer id) {
		...
		try {
			CaseInfo instance = (CaseInfo) sessionFactory.getCurrentSession()
					.get("pojo.classes.CaseInfo", id);
			if (instance == null) {
	...
	public List findByExample(CaseInfo instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("pojo.classes.CaseInfo")
