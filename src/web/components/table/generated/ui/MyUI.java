package web.components.table.generated.ui;
...
public abstract class MyUI extends MedinsUI {
	...
	/**
	 * Removes all active popup web.components.table.generated.windows (both edit and list).
	 */
