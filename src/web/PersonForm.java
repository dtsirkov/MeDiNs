...
public class PersonForm extends CustomComponent {
	...
	public PersonForm(VaadinRequest request) {
		...
		//manage labels 
		personSocialNumberLb.setValue(ManageProperty.getLabelDtl("personSocialNumber" + "_" + language));
		personTitleLb.setValue(ManageProperty.getLabelDtl("personTitle" + "_" + language));
		personFirstNameLb.setValue(ManageProperty.getLabelDtl("personFirstName" + "_" + language));
		personMiddleNameLb.setValue(ManageProperty.getLabelDtl("personMiddleName" + "_" + language));
		personLastNameLb.setValue(ManageProperty.getLabelDtl("personLastName" + "_" + language));
		personBirthDateLb.setValue(ManageProperty.getLabelDtl("personBirthDate" + "_" + language));
		personSexLb.setValue(ManageProperty.getLabelDtl("personSex" + "_" + language));
		personRoleLb.setValue(ManageProperty.getLabelDtl("personRole" + "_" + language));
		personJobTitleLb.setValue(ManageProperty.getLabelDtl("personJobTitle" + "_" + language));
