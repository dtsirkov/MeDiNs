...
public class SearchCaseForm<CaseInfo> extends Form implements StepIntrfc{
	...
	private HashMap<String, ArrayList<Object>> searchConstraint = new HashMap<String, ArrayList<Object>>();
	...
	public HashMap<String, ArrayList<Object>> getSearchConstraint() {
		return searchConstraint;
	}

	public void setSearchConstraint(
			HashMap<String, ArrayList<Object>> searchConstraint) {
	...
	public Layout buildMainLayout(String mode){
		...
		searchButton.addClickListener(new Button.ClickListener() {
			...
			String key;
			HashMap<String, ArrayList<Object>> searchConstraintFiltered;
			Iterator<String> constraintIterator;

			public void buttonClick(ClickEvent event) {

				searchConstraintFiltered = new HashMap<String, ArrayList<Object>>();
				...
				List<CaseInfo> resultList = (List<CaseInfo>) dao.searchByConstraintsWithOp(dBTableName, searchConstraintFiltered);
	...
	public HashMap<String, ArrayList<Object>> addToSearchConstraint(final TextField textField,final String op, final String key){
